...
const Footer = () => {
  return ( 
    <div className='container mt-5 border rounded-top-5  py-lg-5 py-3 px-lg-6 px-4 mb-3 rounded-bottom-2 shadow ' 
         style={{backgroundColor:"#f7f7f7"}}
    >
      <div className='row mb-4 justify-content-between'>
 
  <div className='col-lg-3 col-12 d-flex flex-column gap-3 mb-4 mb-lg-0 mx-2'>
    <img 
    ...
    <p className='text-muted mb-0'>
      &copy; 2026, Finexa Broking Ltd.<br />All rights reserved.
    </p>
